...
import hashlib
from ai_utils import detect_greenwashing, suggest_sustainable_alternatives, calculate_sustainability_score
...
def analyze_product():
    ...
    greenwashing_analysis = detect_greenwashing(product_description)
    
    # Calculate sustainability score
    sustainability_score = calculate_sustainability_score(product_description, greenwashing_analysis)
    
    # Get sustainable alternatives
    alternatives = suggest_sustainable_alternatives(product_category, product_name)
